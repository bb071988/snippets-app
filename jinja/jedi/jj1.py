...
@app.route("/<first_name>/<last_name>")
def template_test():
#     return render_template('template.html', first_name, last_name, jedi_name) # does not work
#     return render_template('template.html', first_name="bob",last_name="braico",jedi_name="jedijedi") # works
    return render_template('template.html', first_name=first_name, last_name=last_name, jedi_name=jedi_name)
